...
///
/// https://github.com/CalixtoTheBugHunter/talos/issues/38 — "A forward-only
/// migration runner applies versioned migrations at launch."
...
public enum DatabaseError: Error, Equatable {
    ...
    /// — "Every session record, memory, and board reference needs a project
    /// identifier from day one, even while there is only ever one."
