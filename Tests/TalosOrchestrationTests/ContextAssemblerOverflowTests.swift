...
struct ContextAssemblerOverflowTests {
    ...
    func dropsInTheDeclaredOrder() {
        ...
        let connectorsTokens = TokenEstimate.approximate(ConnectorsContextRendering.render(connectorsManifest))
        ...
        let ceiling = pinnedTotal + connectorsTokens + specDriveTokens
        #expect(pinnedTotal + boardTokens + connectorsTokens + specDriveTokens > ceiling)
