...
| `execute-issue` | ❌ [#138](https://github.com/CalixtoTheBugHunter/talos/issues/138) | Implementing a board item | `Ready` → `In progress` → `In review` | [RIPER-5](https://github.com/CalixtoTheBugHunter/talos/wiki/Engineering-Standards#riper-5-how-an-agent-executes-an-issue) — no Execute without an approved Plan |
| `review-pr` | ❌ [#139](https://github.com/CalixtoTheBugHunter/talos/issues/139) | Reviewing a PR | `In review` → `Done`, or back | [Adversarial review](https://github.com/CalixtoTheBugHunter/talos/wiki/Engineering-Standards#review-is-adversarial-by-default) — refute the change, verify every acceptance criterion, the tests, and every constraint page touched |
| `update-spec` | ❌ [#140](https://github.com/CalixtoTheBugHunter/talos/issues/140) | Changing the wiki | None — it is the gate on the SPEC itself, and on leaving `Blocked` | That a SPEC change is a [decision](https://github.com/CalixtoTheBugHunter/talos/wiki/Decision-Log), that binding changes are appended rather than rewritten, and the [may-and-may-not-touch](https://github.com/CalixtoTheBugHunter/talos/wiki/Contributing#guidelines-you-may-and-may-not-touch) split |

**Until the three unbuilt skills exist,** the work they own is not unguarded — it is guarded by
[`spec-driven-change`](spec-driven-change/SKILL.md), which covers any Talos change, plus the
constraint skills. It is guarded less specifically, which is why those three are board items rather
than a nice-to-have.
