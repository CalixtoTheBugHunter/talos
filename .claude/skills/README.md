...
**Until the two unbuilt skills exist,** the work they own is not unguarded — it is guarded by
[`spec-driven-change`](spec-driven-change/SKILL.md), which covers any Talos change, plus the
constraint skills. It is guarded less specifically, which is why those two are board items rather
than a nice-to-have.
